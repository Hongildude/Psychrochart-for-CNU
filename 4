...
# Calculate specific volume grid
...
# Plot specific volume contours
specific_volume_levels = np.arange(0.75, 2.5, 0.25) * 1e-3  # Define contour levels for specific volume
specific_volume_plot = ax.contour(T_grid - 273.15, W_grid, V_grid, levels=specific_volume_levels, colors='b', linewidths=0.8)

# Add contour labels for specific volume
ax.clabel(specific_volume_plot, colors='k', fontsize=8, fmt="%1.4f m³/kg", inline=True, inline_spacing=10)
...
# Plot specific volume contours
specific_volume_levels = np.arange(0.75, 0.95, 0.01)  # Define contour levels for specific volume
specific_volume_plot = ax.contour(T_grid - 273.15, W_grid, V_grid, levels=specific_volume_levels, colors='k', linewidths=0.8)

# Add contour labels for specific volume
ax.clabel(specific_volume_plot, colors='k', fontsize=8, fmt="%1.2f") # 나중에 위치 바꿀수도 있음
